...
namespace ImGui
{
    ...
    IMGUI_API bool          CheckboxFlagsS64(const char* label, ImS64* flags, ImS64 flags_value);
    IMGUI_API bool          CheckboxFlagsU64(const char* label, ImU64* flags, ImU64 flags_value);
